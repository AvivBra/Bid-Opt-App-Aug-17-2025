"""Bid Optimizer page - Complete working version with 3-column layout."""
...
class BidOptimizerPage:
    ...
    def render(self):
        ...
        # Create 3 columns layout: [left | middle | right]
        ...
        # ALL CONTENT IN MIDDLE COLUMN - narrower for better centering
        with col_middle:
                        ...
                        try:
                            with st.spinner("Processing files..."):
                                ...
                                success, msg, template_data = (
                                    excel_reader.read_template_file(
                                        template_file.read()
                                    )
                                )
                                if not success:
            ...
            if st.session_state.get("processing_complete"):
                ...
                with col2:
                    ...
                    if stats := st.session_state.get("output_stats"):
                        ...
                        with col_stat2:
                            st.metric(
                                "Rows Modified", f"{stats.get('rows_modified', 0):,}"
                            )
        ...
        # RIGHT COLUMN (col_right) STAYS EMPTY - not used
