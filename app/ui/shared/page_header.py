...
def render_section_header(
    title: str, uppercase: bool = True, icon: Optional[str] = None
) -> None:
    """
...
def render_subsection_header(title: str, description: Optional[str] = None) -> None:
    """
...
def render_status_header(status: str, status_type: str = "info") -> None:
    """
...
def render_breadcrumb(path: list, separator: str = "/") -> None:
    """
...
def render_help_text(text: str, style: str = "inline") -> None:
    """
...
def render_page_title_with_actions(title: str, actions: Optional[list] = None) -> None:
    """
