...
def create_primary_button(label: str, key: str = None, disabled: bool = False, help_text: str = None) -> bool:
...
def create_secondary_button(label: str, key: str = None, disabled: bool = False, help_text: str = None) -> bool:
...
def create_download_button(label: str, data, filename: str, mime_type: str, key: str = None) -> bool:
...
def create_icon_button(icon: str, label: str, button_type: str = "secondary", **kwargs) -> bool:
...
def create_action_buttons():
    ...
    with col2:
        actions['process'] = create_primary_button(
            "⚡ Process Files", 
            key="process_button",
            disabled=not _has_required_files()
        )
...
def _has_required_files() -> bool:
    ...
    return (st.session_state.get('template_uploaded', False) and 
